...
var ProjectMetricDetailComponent = (function () {
    ...
    ProjectMetricDetailComponent.prototype.getProjectMetrics = function (projectId) {
        var _this = this;
        this.projectMetricService.getProjectMetrics(projectId).subscribe(function (projectMetrics) { return _this.projectMetrics = projectMetrics; }, function (error) { return _this.errorMessage = error; });
    };
